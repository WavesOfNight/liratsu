...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_games_status" AS ENUM('live', 'soon', 'off');
  CREATE TYPE "public"."enum_games_engine" AS ENUM('ratsu', 'custom');
  CREATE TYPE "public"."enum_game_assets_kind" AS ENUM('sprite', 'music');
  ...
  CREATE TYPE "public"."enum_schedule_archive_kind" AS ENUM('game', 'art', 'music', 'chat');
  ...
  CREATE TYPE "public"."enum_game_settings_ratsu_unlocks_condition" AS ENUM('floor', 'score', 'win', 'daily');
  ...
  CREATE TYPE "public"."enum_game_settings_ratsu_difficulty" AS ENUM('easy', 'normal', 'hard');
  ...
  CREATE TABLE "scores" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"game" varchar DEFAULT 'the-ratsu' NOT NULL,
  ...
  CREATE TABLE "games" (
  	...
  	"title" varchar NOT NULL,
  	"slug" varchar,
  	"status" "enum_games_status" DEFAULT 'live' NOT NULL,
  	"order" numeric DEFAULT 0,
  	"tagline" varchar,
  	"color" varchar DEFAULT '#3FA9F5',
  	"thumbnail_id" integer,
  	"engine" "enum_games_engine" DEFAULT 'ratsu' NOT NULL,
  	"code" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "game_assets" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar NOT NULL,
  	"kind" "enum_game_assets_kind" DEFAULT 'sprite' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"url" varchar,
  	"thumbnail_u_r_l" varchar,
  ...
  CREATE TABLE "schedule_archive" (
  	...
  	"game" varchar,
  	"box_art_url" varchar,
  	"kind" "enum_schedule_archive_kind" DEFAULT 'game',
  	"vod_url" varchar,
  	"vod_found" boolean,
  	"vod_title" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"games_id" integer,
  	"game_assets_id" integer,
  	"legal_pages_id" integer,
  	"schedule_archive_id" integer,
  ...
  CREATE TABLE "site_settings" (
  	...
  	"footer_text" varchar DEFAULT '© Liratsu',
  ...
  CREATE TABLE "game_settings_ratsu_unlocks" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"condition" "enum_game_settings_ratsu_unlocks_condition" NOT NULL,
  ...
  CREATE TABLE "game_settings_ratsu_music_tracks" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  ...
  CREATE TABLE "game_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"ratsu_enabled" boolean DEFAULT true,
  	"ratsu_leaderboard_enabled" boolean DEFAULT true,
  	"ratsu_difficulty" "enum_game_settings_ratsu_difficulty" DEFAULT 'normal',
  	"ratsu_start_hearts" numeric DEFAULT 3,
  	"ratsu_floors" numeric DEFAULT 5,
  	"ratsu_max_score_per_second" numeric DEFAULT 60,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  CREATE TABLE "integrations" (
  	...
  	"youtube_vod_channel_handle" varchar DEFAULT 'LiratsuVOD',
  	...
  	"discord_schedule_webhook_url" varchar,
  ...
  ALTER TABLE "games" ADD CONSTRAINT "games_thumbnail_id_media_id_fk" FOREIGN KEY ("thumbnail_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_game_assets_fk" FOREIGN KEY ("game_assets_id") REFERENCES "public"."game_assets"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_schedule_archive_fk" FOREIGN KEY ("schedule_archive_id") REFERENCES "public"."schedule_archive"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "game_settings_ratsu_unlocks" ADD CONSTRAINT "game_settings_ratsu_unlocks_reward_id_surprise_codes_id_fk" FOREIGN KEY ("reward_id") REFERENCES "public"."surprise_codes"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "game_settings_ratsu_unlocks" ADD CONSTRAINT "game_settings_ratsu_unlocks_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."game_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "game_settings_ratsu_music_tracks" ADD CONSTRAINT "game_settings_ratsu_music_tracks_file_id_game_assets_id_fk" FOREIGN KEY ("file_id") REFERENCES "public"."game_assets"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "game_settings_ratsu_music_tracks" ADD CONSTRAINT "game_settings_ratsu_music_tracks_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."game_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "games_thumbnail_idx" ON "games" USING btree ("thumbnail_id");
  ...
  CREATE INDEX "game_assets_updated_at_idx" ON "game_assets" USING btree ("updated_at");
  CREATE INDEX "game_assets_created_at_idx" ON "game_assets" USING btree ("created_at");
  CREATE UNIQUE INDEX "game_assets_filename_idx" ON "game_assets" USING btree ("filename");
  CREATE INDEX "game_assets_sizes_thumb_sizes_thumb_filename_idx" ON "game_assets" USING btree ("sizes_thumb_filename");
  ...
  CREATE INDEX "schedule_archive_date_idx" ON "schedule_archive" USING btree ("date");
  CREATE INDEX "schedule_archive_updated_at_idx" ON "schedule_archive" USING btree ("updated_at");
  CREATE INDEX "schedule_archive_created_at_idx" ON "schedule_archive" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_game_assets_id_idx" ON "payload_locked_documents_rels" USING btree ("game_assets_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_schedule_archive_id_idx" ON "payload_locked_documents_rels" USING btree ("schedule_archive_id");
  ...
  CREATE INDEX "game_settings_ratsu_unlocks_order_idx" ON "game_settings_ratsu_unlocks" USING btree ("_order");
  CREATE INDEX "game_settings_ratsu_unlocks_parent_id_idx" ON "game_settings_ratsu_unlocks" USING btree ("_parent_id");
  CREATE INDEX "game_settings_ratsu_unlocks_reward_idx" ON "game_settings_ratsu_unlocks" USING btree ("reward_id");
  ...
  CREATE INDEX "game_settings_ratsu_music_tracks_order_idx" ON "game_settings_ratsu_music_tracks" USING btree ("_order");
  CREATE INDEX "game_settings_ratsu_music_tracks_parent_id_idx" ON "game_settings_ratsu_music_tracks" USING btree ("_parent_id");
  CREATE INDEX "game_settings_ratsu_music_tracks_file_idx" ON "game_settings_ratsu_music_tracks" USING btree ("file_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "game_assets" CASCADE;
  DROP TABLE "legal_pages" CASCADE;
  DROP TABLE "_legal_pages_v" CASCADE;
  DROP TABLE "schedule_archive" CASCADE;
  ...
  DROP TABLE "game_settings_ratsu_unlocks" CASCADE;
  DROP TABLE "game_settings_ratsu_sprite_overrides" CASCADE;
  DROP TABLE "game_settings_ratsu_music_tracks" CASCADE;
  ...
  DROP TYPE "public"."enum_games_engine";
  DROP TYPE "public"."enum_game_assets_kind";
  ...
  DROP TYPE "public"."enum_schedule_archive_kind";
  ...
  DROP TYPE "public"."enum_game_settings_ratsu_unlocks_condition";
  DROP TYPE "public"."enum_game_settings_ratsu_sprite_overrides_key";
  DROP TYPE "public"."enum_game_settings_ratsu_difficulty";
