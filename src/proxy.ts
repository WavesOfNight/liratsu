...
export function proxy(request: NextRequest) {
  ...
  const csp = [
    ...
    `frame-src https://player.twitch.tv https://clips.twitch.tv https://www.youtube-nocookie.com https://www.tiktok.com https://www.instagram.com https://www.paypal.com https://*.paypal.com`,
    `media-src 'self'`,
    `object-src 'none'`,
    `base-uri 'self'`,
